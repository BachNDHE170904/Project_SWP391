                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <label class="btn btn-outline-primary">
                                                <a class="nav-link active" aria-current="page" href="UpdateProfileServlet">Update Profile</a>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="account-general">
                                <div class=container text-center"">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="${sessionScope.userDetail.getAvt()}" alt class="img-fluid" width="200" height="200">
                                        </div>
                                        <div class="col-md-9">
                                            <label class="btn btn-outline-primary">
                                                <a class="nav-link active" aria-current="page" href="UpdateProfileServlet">Update Profile</a>
