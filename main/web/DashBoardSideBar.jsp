...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="AdminManageUsers.jsp?page=1" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Manage Users</a>
            ...
            <a href="AdminManageMentor.jsp?page=1" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Manage Mentors</a>
            <a href="ListRequestController" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Manage Requests</a>
            <a href="StatisticOfAllMentee.jsp?page=1" class="nav-item nav-link"><i class="fa fa-tasks me-2"></i>Statistic Of All Mentee</a>
        </div>
    </nav>
</div>