                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-1" value="${sessionScope.userDetail.getEmail()}" readonly>
                            ...
                            <div class="card-body pb-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select">
                                        ...
                                        <option ${sessionScope.userDetail.sex?"selected":""}>Male</option>
                                        <option  ${sessionScope.userDetail.sex?"":"selected"}>Female</option>
                                        <option>Other</option>
                                    </select>
                                </div>
                                <div class="form-group">
