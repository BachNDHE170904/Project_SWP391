...
public class CreateCVServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String profession_introduction = request.getParameter("profession_introduction").trim();
            String service_description = request.getParameter("service_description").trim();
            String achievement_description = request.getParameter("achievement_description").trim();
